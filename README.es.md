...
Los datos se almacenan solo en su dispositivo y no se comparten de ninguna manera con ningún servidor. Esto significa que estos datos solo están en su dispositivo actual, y que debe usar las opciones de Exportar Datos en Avanzado si necesita guardar copias de estos datos.
...
1. Copie `scripts/i18n/en.js` como punto de partida
