...
register_i18n_language('pig', {
  ...
  translations: {
    ...
    "config": {
      "title": "Onfiguration-Cay (Ession/Round/Game-Say)",
      "instructions_title": "Instructions-ay",
      "instructions": "Is-thay is-ay a-ay ore-scay eeper-kay or-fay e-thay Athfinder-Pay Ible-Bay Experience-ay (aka-ay e-thay Ible-Bay Owl-Bay). Ease-play enter-ay our-yay umber-nay of-ay eams-tay as-ay ell-way as-ay ocks/groups-blay elow-bay o-say at-thay e-thay oring-scay id-gray an-cay e-bay eated-cray",
    ...
    "blocks": {
      ...
      "count_one": "{{count}} ock/group-blay",
    ...
    "score_entry": {
      ...
      "block_group": "Ock/Group-Blay"
    },
    "scores": {
      "team_exact": "Ore-Scay y-bay Eam-Tay (Exact-ay)",
      "team_rounded": "Ore-Scay y-bay Eam-Tay (Ounded-Ray)",
      "by_block": "Ore-Scay y-bay Ock/Group-Blay",
      "team_and_block": "Ore-Scay y-bay Eam-Tay & Ock/Group-Blay",
    ...
    "table": {
      ...
      "block_name": "Ock/Group-Blay Ame-Nay",
      "question": "Uestion-Qay",
    ...
    "history": {
      ...
      "actions": {
        ...
        "add_block": "Add-ay Ock/Group-Blay",
        "delete_block": "Elete-Day Ock/Group-Blay",
        "rename_block": "Ename-Ray Ock/Group-Blay",
        ...
        "reorder_blocks": "Eorder-Ray Ocks/Groups-Blay"
      },
      "details_templates": {
    ...
    "advanced": {
      ...
      "export_block": "Export-ay Ore-Scay y-bay Ock/Group-Blay",
      "export_team_and_block": "Export-ay Ore-Scay y-bay Eam-Tay & Ock/Group-Blay",
      "export_question_log": "Export-ay Uestion-Qay Og-Lay",
      "export_json": "Export-ay or-fay Importing-ay",
      "export_session": "Export-ay Ession-Say (Ound/Game-Ray)",
      ...
      "delete": "Elete-Day",
      "delete_session": "Elete-Day is-thay Ession-Say (Ound/Game-Ray)",
    ...
    "placeholders": {
      ...
      "block_scores": "Ock/Group-Blay Ores-Scay O-Gay Ere-Hay",
      "team_block_scores": "Eam-Tay & Ock/Group-Blay Ores-Scay O-Gay Ere-Hay",
      "question_log": "Uestion-Qay Og-Lay Oes-Gay Ere-Hay"
    },
    "defaults": {
      "session_name": "Ession-Say {{date}}",
      "team_name": "Eam-Tay {{number}}",
      "block_name": "Ock/Group-Blay {{number}}",
      "no_block": "O-Nay Ock/Group-Blay",
