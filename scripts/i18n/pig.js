...
register_i18n_language('pig', {
  ...
  translations: {
    ...
    "config": {
      "title": "Onfiguration-Cay (Iz-Quay)",
      "session_title": "Iz-Quay",
      ...
      "new_session": "Ew-Nay Iz-Quay",
      "enter_scores": "Enter-ay Ores-Scay"
    },
    "session_nav": {
      "previous": "Evious-Pray Iz-Quay",
      "next": "Ext-Nay Iz-Quay"
    },
    "teams": {
    ...
    "blocks": {
      ...
      "manage_button": "Anage-May Ocks-Blay",
      "manage_title": "Anage-May Ocks-Blay",
      "manage_close": "Ose-Clay",
    ...
    "rounding": {
      "title": "Ive-Lay Ore-Scay",
      "title_classic": "Ounding-Ray Ive-Lay Eam-Tay ore-scay o-tay est-bay eam's-tay otal-tay?",
      "yes": "Ounded-Ray",
      "no": "Exact-ay"
    },
    "timer": {
      ...
      "auto_start": "Auto-ay art-stay imer-tay en-whay ore-scay is-ay elected-say",
    ...
    "score_entry": {
      ...
      "previous_short": "Evious-Pray Uestion-Qay",
      "next_short": "Ext-Nay Uestion-Qay",
      "new": "Ew-Nay Uestion-Qay",
      "new_short": "Ew-Nay Uestion-Qay",
    ...
    "edit_log": {
      ...
      "global": "Obal-Glay",
      "current_session": "Urrent-Cay Iz-Quay",
      "unknown_time": "Unknown-ay",
      "actions": {
        "change": "Ange-Chay",
        "rename_session": "Ename-Ray Iz-Quay",
        "add_team": "Add-ay Eam-Tay",
        "delete_team": "Elete-Day Eam-Tay",
        ...
        "export_all_sessions": "Export-ay All-ay Izzes-Quay",
        "reorder_teams": "Eorder-Ray Eams-Tay",
        "reorder_blocks": "Eorder-Ray Ocks-Blay",
        "merge": "Erge-May Izzes-Quay",
      ...
      "details_templates": {
        ...
        "auto_increased_max_points": "Auto-ay-increased-ay ax-may oints-pay om-fray {{old}} o-tay {{new}} (ore-scay exceeded-ay imit-lay)",
        ...
        "exported_session_yjs": "Exported-ay iz-quay as-ay .yjs ile-fay",
        "exported_session_json": "Exported-ay iz-quay as-ay JSON-ay ile-fay",
        "exported_session_json_fallback": "Exported-ay iz-quay as-ay JSON-ay ile-fay (allback-fay)",
        "exported_all_yjs": "Exported-ay all-ay izzes-quay as-ay .yjs ile-fay",
        "exported_all_json": "Exported-ay all-ay izzes-quay as-ay JSON-ay ile-fay",
        "exported_all_json_fallback": "Exported-ay all-ay izzes-quay as-ay JSON-ay ile-fay (allback-fay)",
    ...
    "advanced": {
      ...
      "merge": "Erge-May",
      "merge_sessions": "Erge-May Izzes-Quay",
      "auto_merge": "Auto-ay Erge-May Uplicates-Day",
      "delete": "Elete-Day",
      "delete_session": "Elete-Day is-thay Iz-Quay",
      "no_import_support": "Our-Yay Owser-Bray oes-day ot-nay upport-say importing-ay.",
      "device_migration": "Evice-Day Igration-May",
      "migration_description": "Ansfer-Tray all-ay izzes-quay etween-bay evices-day using-ay eer-pay-o-tay-eer-pay ync-say.",
      ...
      "migration_progress": "Ansferring-Tray iz-quay {{current}} of-ay {{total}}: {{name}}",
      "migration_complete": "Igration-May omplete-cay! {{count}} izzes-quay ansferred-tray.",
      ...
      "close_button": "Ose-Clay",
      "pwa_tools": "PWA-ay Ools-Tay",
      "pwa_tools_description": "Anagemay updates-ay and-ay iew-vay offline-ay iagnostics-day or-fay is-thay installed-ay app-ay.",
      "pwa_status_title": "Offline-ay Iagnostics-Day",
      "pwa_refresh_status": "Efresh-Ray Iagnostics-Day",
      "pwa_status_installed": "Installed-ay as-ay app-ay",
      "pwa_status_online": "Etwork-Nay available-ay",
      "pwa_status_service_worker": "Ervice-Say orker-way registered-ay",
      "pwa_status_service_worker_control": "Ervice-Say orker-way ontrolling-cay is-thay age-pay",
      "pwa_status_sync": "Ync-Say ate-stay",
      "pwa_status_periodic_sync": "Eriodic-Pay ackground-bay ync-say",
      "pwa_status_last_update_check": "Ast-Lay update-ay eck-chay",
      "pwa_status_yes": "Es-Yay",
      "pwa_status_no": "O-Nay",
      "pwa_status_unknown": "Unknown-ay",
      "pwa_status_never": "Ever-Nay",
      "install_app": "Install-ay as-ay App-ay",
      "install_success": "App-ay installed-ay successfully-ay.",
      "install_instructions_ios": "O-tay install-ay: ap-tay Are-Shay in-ay Afari-Say, en-thay Add-ay o-tay Ome-Hay Eenscray.",
      "install_instructions_android": "O-tay install-ay: open-ay owser-bray enu-may, en-thay ap-tay Install-ay app-ay or-ay Add-ay o-tay ome-hay eenscray.",
      "install_instructions_desktop": "O-tay install-ay: use-ay e-thay install-ay icon-ay in-ay e-thay owser-bray address-ay ar-bay or-ay owser-bray enu-may.",
      "check_updates": "Heck-Cay or-fay Updates-ay",
      "reload_app": "Eload-Ray App-ay",
      "reload_now": "Eload-Ray Ow-Nay",
      "clear_cache": "Lear-Cay Ache-Cay And-ay Estart-Ray",
      "clear_cache_confirm": "Is-Thay ill-way ear-clay app-ay ile-fay ache-cay and-ay estart-ray e-thay app-ay. Aved-Say izzes-quay are-ay ored-stay eparately-say.",
      "update_available": "App-ay Update-ay is-ay Available-ay! Eload-Ray o-tay Apply-ay.",
      "update_ready_deferred": "Update-ay is-ay eady-ray. It-ay ill-way apply-ay en-whay e-thay app-ay is-ay idle-ay or-ay reopened-ay.",
    ...
    "defaults": {
      ...
      "extra_credit": "Extra-ay Edit-Cray",
      "unnamed_session": "Unnamed-ay Iz-Quay"
    },
    "confirm": {
    ...
    "alerts": {
      ...
      "cannot_delete_only_session": "Ou-Yay ay-may ot-nay elete-day e-thay only-ay Iz-Quay",
      ...
      "failed_import_session_id": "Ailed-Fay o-tay import-ay iz-quay {{id}}: {{error}}",
      "failed_import_session": "Ailed-Fay o-tay import-ay iz-quay: {{error}}",
      "failed_convert_localstorage": "Ailed-Fay o-tay onvert-cay ocalStorage-lay ormat-fay: {{error}}"
    },
    "history_global": {
      "actions": {
        "create_session": "Eate-Cray Iz-Quay",
        "switch_session": "Witch-Say Iz-Quay",
        "delete_session": "Elete-Day Iz-Quay",
        "merge_session": "Erge-May Iz-Quay",
        "reorder_sessions": "Eorderray Izzesquay",
        "import": "Importway"
      },
      "details_templates": {
        "created_session": "Eatedcray \"{{name}}\"",        "created_synced_session": "Eated-Cray ynced-say iz-quay \"{{name}}\"",        "switched_session": "Itchedsway otay \"{{name}}\"",
    ...
    "sync": {
      ...
      "has_sync_room": "Is-thay iz-quay as-hay een-bay ynced-say",
      ...
      "join_choice_title": "Oin-Jay Iz-Quay",
      "join_choice_description": "Is-Thay oom-ray as-hay an-ay existing-ay iz-quay. At-Whay ould-way ou-yay ike-lay o-tay o-day?",
      "join_choice_new_session": "Eate-Cray ew-nay ocal-lay iz-quay (ecommended-ray)",
      "join_choice_new_session_desc": "Art-Stay esh-fray ith-way e-thay oom's-ray ata-day in-ay a-ay ew-nay iz-quay",
      "join_choice_merge_session": "Erge-May into-ay urrent-cay iz-quay",
      "join_choice_merge_session_desc": "Ombine-Cay oom-ray ata-day ith-way our-yay urrent-cay iz-quay",
      ...
      "error_session_deleted": "Iz-Quay as-way eleted-day. Isconnecting-Day om-fray ync-say.",
      ...
      "session_switch_disconnect": "Witched-Say izzes-quay. Isconnected-Day om-fray ync-say oom-ray.",
      "auto_reconnected": "Econnected-Ray o-tay oom-ray {{code}}",
      "switch_confirm_title": "Eave-Lay Ync-Say Oom-Ray?",
      "switch_confirm_message": "Ou-Yay are-ay urrently-cay yncing-say ith-way oom-ray {{code}}. Witching-Say izzes-quay ill-way isconnect-day ou-yay.",
      "switch_confirm": "Witch-Say Iz-Quay",
      ...
      "aria_peer_joined": "{{name}} as-hay oined-jay e-thay iz-quay",
      "aria_peer_left": "{{name}} as-hay eft-lay e-thay iz-quay",
      ...
      "join_choice_join_session": "Oin-Jay Iz-Quay",
      ...
      "join_merge_warning": "Only-ay use-ay erge-may if-ay ou-yay understand-ay at-thay it-ay adds-ay our-yay ocal-lay eams-tay/ocks-blay o-tay e-thay ynced-say iz-quay.",
      "join_button": "Oin-Jay",
      "receiving_data": "Eceiving-Ray iz-quay ata-day...",
      "synced_session_name": "Ynced-Say Iz-Quay {{date}}",
      "merge_nothing_to_add": "All-ay items-ay already-ay exist-ay in-ay e-thay ynced-say iz-quay",
      ...
      "merge_preview_description": "E-Thay ollowing-fay items-ay ill-way e-bay added-ay o-tay e-thay ynced-say iz-quay:",
    ...
    "backup": {
      ...
      "restored_success": "Iz-Quay estored-ray om-fray ackup-bay",
      "restore_failed": "Ailed-Fay o-tay estore-ray om-fray ackup-bay",
      "view_backups": "Iew-Vay Ackups-Bay",
      "browser_title": "Iz-Quay Ackups-Bay",
      "browser_description": "Ackups-Bay or-fay \"{{session}}\"",
      "no_backups": "O-Nay ackups-bay available-ay or-fay is-thay iz-quay",
      "column_date": "Ate-Day",
    ...
    "session_manager": {
      "dialog_title": "Anagemay Izzesquay",
      "description": "Enameray, eorderray, orway eleteday izzesquay",
      ...
      "manage_button": "Anagemay Izzesquay",
      "reorder_hint": "Agdray izzesquay otay eorderray"
    },
    "session_dialogs": {
      "continue_or_new_title": "Elcome-Way Ack-Bay!",
      "continue_or_new_message": "Ould-Way ou-yay ike-lay o-tay ontinue-cay ith-way our-yay evious-pray iz-quay or-ay art-stay esh-fray ith-way a-ay ew-nay one-ay?",
      "continue_session": "Ontinue-Cay Evious-Pray",
      "start_new_session": "Art-Stay Ew-Nay",
      "current_session_label": "Evious-Pray:"
    },    "merge": {
      "dialog_title": "Erge-May Izzes-Quay",
      "select_source": "Elect-Say Ource-Say Iz-Quay",
      "select_target": "Elect-Say Arget-Tay Iz-Quay",
      "source_help": "Ata-Day om-fray is-thay iz-quay ill-way e-bay erged-may into-ay e-thay arget-tay",
      "target_help": "Is-Thay iz-quay ill-way eceive-ray e-thay erged-may ata-day",
      "merge_button": "Erge-May",
      "cancel_button": "Ancel-Cay",
      "same_session_error": "Ease-Play elect-say o-tway ifferent-day izzes-quay",
      "no_sessions_error": "Ou-Yay eed-nay at-ay east-lay o-tway izzes-quay o-tay erge-may",
      "merge_success": "Izzes-Quay erged-may uccessfully-say",
      "merge_failed": "Erge-May ailed-fay: {{error}}",
      "matching_source": "Ource-Say",
      "matching_target": "Arget-Tay",
      "confirm_merge": "Onfirm-Cay Erge-May",
      "auto_merge_no_duplicates": "O-Nay uplicate-day izzes-quay ound-fay o-tay erge-may",
      ...
      "source_session": "Ource-Say Iz-Quay",
